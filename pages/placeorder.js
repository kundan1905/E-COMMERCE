...
getProductData(docId)
 function getProductData(productID){
  const order=document.getElementById("productorder");
  ...
  <tr>
      <td>Product Image</td>
      <td><img src="${myItemData.product_image}"></td>
    </tr>
  <tr>
    <td>Product Name </td>
    <td>${myItemData.item_name}</td>
  </tr>
  <tr>
    <td>Total Price </td>
    <td>&#8377;${myItemData.item_price}</td>
  </tr>
  <tr>
    <td>Shipping</td>
    <td>Free shipping</td>
...
<div>
  <input type="radio" name="dbt" value="dbt" checked> Card payment
</div>
<div>
